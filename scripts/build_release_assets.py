...
''')
        ...
        (control_dir / "control").write_text(f"""Package: {PACKAGE_NAME}\nVersion: {version}\nSection: utils\nPriority: optional\nArchitecture: all\nDepends: python3 (>= 3.10), ffmpeg, python3-tk, python3-pystray, python3-pil, chromium | electron\nInstalled-Size: {installed_size}\nMaintainer: Meeting Recorder Maintainers <noreply@example.invalid>\nDescription: Local-first Linux meeting recorder\n Native system-tray meeting recorder with a dropdown control panel, local recording, transcription workflow, and private meeting folders.\n""", encoding="utf-8")
